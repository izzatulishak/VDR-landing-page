import{k as je,bO as We,cq as Ne,oD as $e,oE as Me,oC as qe,oF as Ge,sr as Ze,Cm as re,Cg as Ye,aT as Ke,kE as Qe,zB as C,zs as oe,oG as Xe,lN as pe,zt as le,Cn as fe,Bz as Je,zD as Q,Aa as et,AM as me,Co as _e,A8 as ve,B$ as tt,zw as at,zA as st,Bu as Ie,zE as se,zF as L,zG as j,c as W,BB as N,zH as Z,Ae as ke,zM as ce,Cp as it,BS as Oe,C1 as nt,_ as M,zU as ge,BC as rt,aa as z,eb as ot,BY as xe,dc as lt,K as ie,Bn as X,iK as ct,ks as ye,em as ut,cI as we,ee as ht,ac as J,et as dt,vk as pt,dZ as be,ke as ft,Ah as mt,jr as _t,kA as vt,Cq as gt,cK as xt,eZ as yt,Cr as wt,b as Re,ds as bt,nh as Pt,N as Ct,nj as St,ax as Tt,go as Pe,nz as At,t as Dt,ni as zt,eh as $t,uK as Mt,aE as qt,aC as Gt,Cs as It,f8 as kt,ml as Ot,kG as Rt,m as ee}from"./index-kVF3p0Vu.js";import{_ as Ft}from"./tiles3DUtils-z6uRRmzK.js";import{l as Bt}from"./LayerView3D-CmxD1VXZ.js";import{d as Et}from"./LayerView-DfQMy9_Y.js";let Ht=class extends je{constructor(e,t,a,i){super(e,0,0,0,t),this.cachedNodes=a,this.memoryMBCached=i}};const T=4096,Fe=16,O=1023,R=O+1,Vt=T*Fe/R,V=4,Be=R*V,Ce=O*V;let Ut=class{constructor(e=Vt){this._pageCount=e;const t=Math.ceil(e/32);this._bitset=new Uint32Array(t)}get pageCount(){return this._pageCount}isAllocated(e){const t=e/32|0,a=e%32;return!!(this._bitset[t]&1<<a)}allocate(e){const t=e/32|0,a=e%32;this._bitset[t]|=1<<a}free(e){const t=e/32|0,a=e%32;this._bitset[t]&=~(1<<a)}findFirstFreePage(){for(let e=0;e<this._bitset.length;e++)if(this._bitset[e]!==4294967295)for(let t=0;t<32;t++){const a=32*e+t;if(a>=this._pageCount)break;if(!(this._bitset[e]&1<<t))return a}return null}resize(e){this._pageCount=e;const t=Math.ceil(e/32),a=this._bitset.length;if(t!==a){const i=new Uint32Array(t),n=Math.min(a,t);i.set(this._bitset.subarray(0,n)),this._bitset=i}this._clearExcessBits(this._bitset,e)}_clearExcessBits(e,t){const a=Math.floor((t-1)/32),i=(t-1)%32;if(t>0&&i<31){const n=(1<<i+1)-1;e[a]&=n}a+1<e.length&&e.fill(0,a+1)}};class Lt{constructor(e,t,a,i,n,r,u){this.handle=e,this.obb=t,this.gaussianAtlasIndices=a,this.pageIds=i,this.positions=n,this.squaredScales=r,this.maxScale=u,this.isVisible=!1,this.usedMemory=We(this.gaussianAtlasIndices,this.positions,this.squaredScales)+this.pageIds.length*Be*4}}class jt extends Ne{constructor(e){super("GaussianSplatSortWorker","sort",{sort:t=>[t.distances.buffer,t.sortOrderIndices.buffer]},e,{strategy:"dedicated"})}sort(e,t){return this.invokeMethod("sort",e,t)}async destroyWorkerAndSelf(){await this.broadcast({},"destroy"),this.destroy()}}let Wt=class{constructor(e){this.texture=null,this._orderTextureCapacity=0,this._rctx=e}ensureCapacity(e){var t;if(this._orderTextureCapacity<e){(t=this.texture)==null||t.dispose();const a=Math.ceil(e*re),i=this._evalTextureSize(a),n=i[0]*i[1];this._orderBuffer=new Uint32Array(n);const r=new $e;r.height=i[0],r.width=i[1],r.pixelFormat=36244,r.dataType=Me.UNSIGNED_INT,r.internalFormat=qe.R32UI,r.wrapMode=33071,r.samplingMode=9728,this.texture=new Ge(this._rctx,r),this._orderTextureCapacity=n}}setData(e,t){var a,i;this.ensureCapacity(t),(a=this._orderBuffer)==null||a.set(e),(i=this.texture)==null||i.setData(this._orderBuffer)}clear(){var e;this._orderTextureCapacity=0,(e=this.texture)==null||e.dispose(),this.texture=null}destroy(){var e;(e=this.texture)==null||e.dispose()}_evalTextureSize(e){const t=Math.ceil(Math.sqrt(e)),a=Math.ceil(e/t);return Ze(t,a)}},Nt=class{constructor(e,t,a){this._splatAtlasTextureHeight=Fe,this.texture=null,this._rctx=e,this._fboCache=a,this.pageAllocator=new Ut,this._cache=t.newCache("gaussian texture cache",i=>i.dispose())}ensureTextureAtlas(){if(this.texture)return;const e=this._cache.pop("splatTextureAtlas");if(e)return void(this.texture=e);const t=new $e;t.height=this._splatAtlasTextureHeight,t.width=T,t.pixelFormat=36249,t.dataType=Me.UNSIGNED_INT,t.internalFormat=qe.RGBA32UI,t.samplingMode=9728,t.wrapMode=33071,this.texture=new Ge(this._rctx,t),this._updatePageAllocator()}grow(){var i,n;if(!this.texture)return this.ensureTextureAtlas(),!1;const e=Math.floor(this._splatAtlasTextureHeight*re);if(e*T>this._rctx.parameters.maxPreferredTexturePixels)return!1;const t=new Ye(this._rctx,this.texture),a=this._fboCache.acquire(T,e,"gaussian splat atlas resize",11);return this._rctx.blitFramebuffer(t,a.fbo,16384,9728,0,0,T,this._splatAtlasTextureHeight,0,0,T,this._splatAtlasTextureHeight),(i=this.texture)==null||i.dispose(),this.texture=(n=a.fbo)==null?void 0:n.detachColorTexture(),t.dispose(),a.dispose(),this._splatAtlasTextureHeight=e,this._updatePageAllocator(),!0}requestPage(){let e=this.pageAllocator.findFirstFreePage();return e===null&&this.grow()&&(e=this.pageAllocator.findFirstFreePage()),e!==null&&this.pageAllocator.allocate(e),e}freePage(e){this.pageAllocator.free(e)}update(e,t,a){this.ensureTextureAtlas(),this.texture.updateData(0,e,t,R,1,a)}_updatePageAllocator(){const e=T*this._splatAtlasTextureHeight/R;this.pageAllocator.pageCount!==e&&this.pageAllocator.resize(e)}clear(){this.texture&&(this._cache.put("splatTextureAtlas",this.texture),this.texture=null)}destroy(){var e;this._cache.destroy(),(e=this.texture)==null||e.dispose()}},Zt=class{constructor(e){this._updating=Ke(!1),this.visibleGaussians=0,this._visibleGaussianTiles=new Array,this._workerHandle=null,this._isSorting=!1,this._pendingSortTask=!1,this._bufferCapacity=0,this._renderer=e,this._orderTexture=new Wt(this._renderer.renderingContext),this._textureAtlas=new Nt(this._renderer.renderingContext,this._renderer.view.resourceController.memoryController,this._renderer.fboCache);const{resourceController:t}=this._renderer.view;this._workerHandle=new jt(Qe(t))}get textureAtlas(){return this._textureAtlas}get orderTexture(){return this._orderTexture}get visibleGaussianTiles(){return this._visibleGaussianTiles}updateGaussianVisibility(e){this._visibleGaussianTiles=e,this.requestSort()}isUpdating(){return this._updating.value}destroy(){var e;this._pendingSortTask=!1,(e=this._workerHandle)==null||e.destroyWorkerAndSelf(),this._textureAtlas.destroy(),this._orderTexture.destroy()}requestSort(){this._updating.value=!0,this._isSorting?this._pendingSortTask=!0:(this._isSorting=!0,this._pendingSortTask=!1,this._sortOnWorker().then(()=>this._handleSortComplete()).catch(()=>this._handleSortComplete()))}_handleSortComplete(){this._isSorting=!1,this._pendingSortTask?this.requestSort():this._updating.value=!1}_clearBuffersAndTextures(){this._bufferCapacity=0,this._orderTexture.clear(),this._textureAtlas.clear()}_ensureBufferCapacity(e){if(this._bufferCapacity<e){const t=Math.ceil(e*re);this._atlasIndicesBuffer=new Uint32Array(t),this._sortedAtlasIndicesBuffer=new Uint32Array(t),this._distancesBuffer=new Float64Array(t),this._sortOrderBuffer=new Uint32Array(t),this._bufferCapacity=t}}async _sortOnWorker(){var x;let e=0;if(this._visibleGaussianTiles.forEach(o=>e+=o.gaussianAtlasIndices.length),e===0)return this.visibleGaussians=0,this._clearBuffersAndTextures(),void this._renderer.requestRender(1);this._ensureBufferCapacity(e),this._textureAtlas.ensureTextureAtlas();const t=this._renderer.camera.eye,a=t[0],i=t[1],n=t[2],r=this._atlasIndicesBuffer.subarray(0,e);let u=0;this._visibleGaussianTiles.forEach(o=>{const c=o.gaussianAtlasIndices,h=o.positions;for(let d=0;d<c.length;d++){r[u]=c[d];const g=3*d,b=h[g],l=h[g+1],p=h[g+2],_=b-a,v=l-i,A=p-n;this._distancesBuffer[u]=_*_+v*v+A*A,u++}});for(let o=0;o<e;o++)this._sortOrderBuffer[o]=o;const f={distances:this._distancesBuffer,sortOrderIndices:this._sortOrderBuffer,numGaussians:e,preciseSort:!1};await((x=this._workerHandle)==null?void 0:x.sort(f).then(o=>{this._distancesBuffer=o.distances,this._sortOrderBuffer=o.sortedOrderIndices;const c=this._sortedAtlasIndicesBuffer.subarray(0,e);for(let d=0;d<e;d++)c[d]=r[o.sortedOrderIndices[d]];this._orderTexture.setData(c,e);const h=this._renderer.view.qualitySettings.gaussianSplat.maxAllowedVisibleGaussians;this.visibleGaussians=Math.min(e,h),this._renderer.requestRender(1)}))}};function Yt(s){s.code.add(C`void computeCovariance3D(in mat3 rotation, in vec3 scale, out vec3 covarianceA, out vec3 covarianceB) {
...
}`)}function Kt(s){s.code.add(C`vec4 unpackColor(uvec4 packedGaussian) {
vec4 color;
...
}`)}function Qt(s){s.code.add(C`mat3 quaternionToRotationMatrix(vec4 q) {
float x2 = q.x + q.x;
float y2 = q.y + q.y;
float z2 = q.z + q.z;
float xx = x2 * q.x;
